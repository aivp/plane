...
urlpatterns = [
    ...
    path(
        "workspaces/<str:slug>/projects/<uuid:project_id>/issues/<uuid:issue_id>/agent-task/",
        IssueAgentTaskEndpoint.as_view(),
        name="project-issue-agent-task",
    ),
    path(
